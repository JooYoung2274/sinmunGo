...
ArticlesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([articles_entity_1.Articles])],
        providers: [
            articles_service_1.ArticlesService,
            {
                provide: articles_interface_1.IArticlesRepository,
                useClass: articles_repository_1.ArticlesRepository,
            },
        ],
